...
class TransmissionPanel(DevPanel):
    ...
    def lostDev(self, err = None):

        lostDev(self.dev.getName(), err)
...
def main():
    ...
    global devList, settings, colourDict
